...
const I18N = {
  en: {
    ...
    block_user: "Block user", unblock_user: "Unblock user", blocked_msg: "Blocked user. Click to reveal.",
  ...
  ru: {
    ...
    block_user: "Заблокировать", unblock_user: "Разблокировать", blocked_msg: "Пользователь заблокирован. Нажмите, чтобы показать.",
