...
const I18N = {
  en: {
    ...
    theme_desc_mono: "Pure black + white — high-contrast dark monochrome",        tab_profile: "Profile", tab_contacts: "Contacts", tab_themes: "Themes", tab_groups: "Group",
  ...
  ru: {
    ...
    theme_desc_mono: "Чистый чёрный + белый — контрастная тёмная монохрома",    tab_profile: "Профиль", tab_contacts: "Контакты", tab_themes: "Темы", tab_groups: "Группа",
