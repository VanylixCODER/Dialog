...
const I18N = {
  en: {
    ...
    theme_desc_mono: "Mostly black with white accents — high-contrast dark monochrome",        tab_profile: "Profile", tab_contacts: "Contacts", tab_themes: "Themes", tab_groups: "Group",
  ...
  gc_create_title: "Create a group",
    gc_name_ph: "Group name",
    gc_desc_ph: "Optional description",
    gc_invite_label: "Invite friends",
    gc_no_friends: "Add friends first to invite them in Contacts",
    gc_create_btn: "Create group",
    gc_cancel_btn: "Cancel",
    gc_preview_default: "New group",
    gc_preview_with_n: "{n} members",
  ...
  ru: {
    ...
    theme_desc_mono: "Преимущественно чёрная с белыми акцентами — контрастная тёмная монохрома",    tab_profile: "Профиль", tab_contacts: "Контакты", tab_themes: "Темы", tab_groups: "Группа",
  ...
  gc_create_title: "Создать группу",
    gc_name_ph: "Название группы",
    gc_desc_ph: "Описание (необязательно)",
    gc_invite_label: "Пригласить друзей",
    gc_no_friends: "Сначала добавьте друзей в разделе Контакты",
    gc_create_btn: "Создать",
    gc_cancel_btn: "Отмена",
    gc_preview_default: "Новая группа",
    gc_preview_with_n: "{n} участников",
