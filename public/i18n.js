...
const I18N = {
  en: {
    ...
    theme_choose: "Choose theme", theme_matrix: "Matrix", theme_amber: "Amber CRT",
    theme_red: "Red alert", theme_contrast: "High contrast", theme_lofi: "Lo-Fi",
    theme_desc_matrix: "Default — phosphor green",
    theme_desc_amber: "Retro amber phosphor",
    theme_desc_red: "Alert red for emergencies",
    theme_desc_contrast: "Pure black + neon — max legibility",
  ...
  ru: {
    ...
    theme_choose: "Выбрать тему", theme_matrix: "Матрица", theme_amber: "Янтарный CRT",
    theme_red: "Тревога", theme_contrast: "Высокий контраст", theme_lofi: "Lo-Fi",
    theme_desc_matrix: "По умолчанию — зелёный фосфор",
    theme_desc_amber: "Старый янтарный монитор",
    theme_desc_red: "Тревожный красный",
    theme_desc_contrast: "Чистый чёрный + неон — максимум читаемости",
